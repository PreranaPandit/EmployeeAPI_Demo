package com.example.employeeapi_demo;
...
import com.example.employeeapi_demo.api.EmployeeAPI;
import com.example.employeeapi_demo.model.Employee;
import com.example.employeeapi_demo.url.URL;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listCall.enqueue(new Callback<List<Employee>>() {
            ...
            public void onResponse(Call<List<Employee>> call, Response<List<Employee>> response) {
                ...
                {
                    Toast.makeText(MainActivity.this, "Error", response.code()).show();
                    return;
                }
            ...
            public void onFailure(Call<List<Employee>> call, Throwable t) {
                ...
                Log.d("Error message", "onFailure: " + t.getLocalizedMessage());
